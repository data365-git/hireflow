...
export const QUESTION_TEMPLATES: QuestionTemplate[] = [
  {
    ...
    questions: [
      { text: "What is your current city of residence?", type: "short-text" },
      { text: "Do you have a valid work permit / ID?", type: "yes-no" },
      { text: "When can you start if hired?", type: "short-text" },
    ],
  },
  {
    id: "qt2",
    ...
    questions: [
      { text: "How many years of relevant work experience do you have?", type: "single-choice", options: ["< 1 year", "1–2 years", "3–5 years", "5+ years"] },
      { text: "Briefly describe your most recent role and main responsibilities.", type: "long-text" },
      { text: "What is your expected monthly salary (USD)?", type: "short-text" },
    ],
  },
  {
    id: "qt3",
    ...
    questions: [
      { text: "Which AI coding tools do you use daily?", type: "single-choice", options: ["Claude Code", "Cursor", "Copilot", "Lovable / v0", "None yet"] },
      { text: "Share a link to a project you built (GitHub, live URL, or demo).", type: "short-text" },
      { text: "How long does it typically take you to ship a working prototype?", type: "single-choice", options: ["< 2 hours", "Half a day", "1–2 days", "3+ days"] },
      { text: "Are you comfortable working directly with a non-technical founder?", type: "yes-no" },
    ],
  },
  {
    id: "qt4",
    ...
    questions: [
      { text: "Do you have B2B sales experience?", type: "yes-no" },
      { text: "On average, how many deals did you close per month in your last role?", type: "single-choice", options: ["1–2", "3–5", "6–10", "10+"] },
      { text: "Which CRM tools have you used?", type: "short-text" },
      { text: "What is the largest deal (USD) you have personally closed?", type: "short-text" },
    ],
  },
  {
    id: "qt5",
    ...
    questions: [
      { text: "Describe your ideal working environment in 1–2 sentences.", type: "long-text" },
      { text: "How do you handle tight deadlines and shifting priorities?", type: "long-text" },
      { text: "Are you comfortable working fully remote with async communication?", type: "yes-no" },
    ],
  },
];
